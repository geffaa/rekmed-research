...
class Encounter extends OAuth2Client
{
    ...
    public function addDiagnosis($id, $code, $display = null)
    {
        ...
        $code_check = SatusehatIcd10::findOne(['icd10_code' => $code]);
        ...
        // Determine ranking
        if (!isset($this->encounter['diagnosis']) || empty($this->encounter['diagnosis'])) {
            $rank = 1;
        } else {
            $rank = count((array)$this->encounter['diagnosis']) + 1;
        }
